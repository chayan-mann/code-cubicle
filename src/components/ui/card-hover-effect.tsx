      ...
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-green-500 dark:bg-green-500 block  rounded-3xl"
...
export const CardTitle = ({
  ...
  return (
    <h4 className={cn("text-zinc-900 font-bold drop-shadow tracking-wide mt-4", className)} style={
      {
